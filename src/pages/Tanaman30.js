...
export default class Tanaman30 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    const datas = `date=${moment().format(
      'YYYY/MM/DD',
    )}&parameters=${satu},${dua},${tiga},${empat},${lima},${enam},${tujuh},${delapan},${sembilan},${sepuluh},${sebelas},${duabelas},${tigabelas},${empatbelas},${limabelas},${enambelas},${tujuhbelas},${delapanbelas},${sembilanbelas},${duapuluh},${duasatu},${satu},${duadua},${tiga},${empat},${lima}`;
    console.log(datas);
    ...
    axios
      .post('https://api.habibigarden.com/growth/31/add', datas, {
          ...
          <View style={{padding: 40}}>
            ...
            <View>
              ...
              <View style={styles.wrapper2}>
                ...
                <View style={styles.wrapper3}>
                  <Text style={styles.label}>Jumlah Anakan:</Text>
                  <TextInput
                    style={styles.textInput}
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
