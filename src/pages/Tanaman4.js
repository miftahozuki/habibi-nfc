...
export default class Tanaman4 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    },${this.state.pressure},${this.state.humidity}`;
    console.log(datas);
    ...
    axios
      .post('https://api.habibigarden.com/growth/4/add', datas, {
  ...
  render() {
    const {temperature, pressure, humidity, isSubmit} = this.state;
