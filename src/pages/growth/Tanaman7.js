...
export default class Tanaman7 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    axios
      .post('https://api.habibigarden.com/growth/7/add', datas, {
              ...
              <View style={styles.wrapper2}>
                <View>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
                    onChangeText={diameter_pangkalB2 =>
                      this.setState({diameter_pangkalB2})
                    }
                    keyboardType="numeric"
                  />
                </View>
