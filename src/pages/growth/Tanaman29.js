...
export default class Tanaman29 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    const datas = `date=${moment().format(
      'YYYY/MM/DD',
    )}&parameters=${satu},${dua},${tiga},${empat},${lima},${enam},${tujuh},${delapan},${sembilan},${sepuluh},${sebelas},${duabelas},${tigabelas},${empatbelas},${limabelas},${enambelas},${tujuhbelas},${delapanbelas},${sembilanbelas},${duapuluh},${duasatu},${duadua}`;
    console.log(datas);
    ...
    axios
      .post('https://api.habibigarden.com/growth/30/add', datas, {
