...
export default class Tanaman56 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    axios
      .post('https://api.habibigarden.com/growth/72/add', datas, {
      ...
      <ScrollView
        ...
        <ImageBackground
          ...
          <View style={styles.brandView}>
            <Text style={styles.brandViewText}>Ponpes Manba'ul{'\n'}Ulum Tasikmalaya</Text>
          </View>
        </ImageBackground>
        {/* bottom view */}
