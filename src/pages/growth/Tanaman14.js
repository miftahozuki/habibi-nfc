...
export default class Tanaman14 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    const datas = `date=${moment().format(
      'YYYY/MM/DD',
    )}&parameters=${tinggi_tanaman},${diameter_pangkal},${jumlah_daunT},${jumlah_daunS},${jumlah_daunR},${panjang_daun},${lebar_daun},${indeks_luas_daun},${diameter_kanopi_t},${diameter_crop},${tinggi_crop},${pH},${n},${p},${k},${suhu},${nutrisi},${kelembapan_udara},${intensitas_cahaya},${tekanan},${kelembapan_tanah}`;
    console.log(datas);
    ...
    axios
      .post('https://api.habibigarden.com/growth/14/add', datas, {
              ...
              <View style={styles.wrapper2}>
                <View>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
                    onChangeText={diameter_kanopi_t =>
                      this.setState({diameter_kanopi_t})
                    }
                    keyboardType="numeric"
                  />
                </View>
                <View style={styles.wrapper3}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
                    onChangeText={diameter_crop =>
                      this.setState({diameter_crop})
                    }
                    keyboardType="numeric"
                  />
                </View>
              ...
              <View style={styles.wrapper2}>
                <View>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
                    onChangeText={tinggi_crop => this.setState({tinggi_crop})}
                    keyboardType="numeric"
                  />
                </View>
                <View style={styles.wrapper3}>
