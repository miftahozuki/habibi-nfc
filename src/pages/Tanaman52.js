...
export default class Tanaman52 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    axios
      .post('https://api.habibigarden.com/growth/63/add', datas, {
      ...
      <ScrollView
        ...
        <ImageBackground
          ...
          <View style={styles.brandView}>
            <Text style={styles.brandViewText}>KT. Karya Ngalalana</Text>
          </View>
        </ImageBackground>
        {/* bottom view */}
