...
export default class Tanaman27 extends Component {
  constructor(props) {
    super(props);
  ...
  data = () => {
    ...
    const datas = `date=${moment().format(
      'YYYY/MM/DD',
    )}&parameters=${satu},${dua},${tiga},${empat},${lima},${enam},${tujuh},${delapan},${sembilan},${sepuluh},${sebelas},${duabelas},${tigabelas},${empatbelas},${limabelas},${enambelas},${tujuhbelas},${delapanbelas},${sembilanbelas},${duapuluh},${duasatu},${duadua},${duatiga},${duaempat},${dualima}`;
    console.log(datas);
    ...
    axios
      .post('https://api.habibigarden.com/growth/28/add', datas, {
      ...
      <ScrollView
        ...
        <ImageBackground
          ...
          <View style={styles.brandView}>
            <Text style={styles.brandViewText}>Desa Tani 3 Cibodas</Text>
          </View>
        </ImageBackground>
        {/* bottom view */}
        <View style={styles.bottomView}>
          ...
          <View style={{padding: 40}}>
            ...
            <View>
              ...
              <View style={styles.wrapper2}>
                <View>
                  <Text style={styles.label}>Jarak Cabang : </Text>
                  <TextInput
                    style={styles.textInput}
                    placeholderTextColor="#c8c8c8"
                    placeholder="Cabang ke 9 - 10         "
              ...
              <View style={styles.wrapper2}>
                <View>
                  <Text style={styles.label}>Kelembaban Tanah : </Text>
                  <TextInput
                    style={styles.textInput}
                    placeholderTextColor="#c8c8c8"
                    placeholder="Masukkan Parameter"
                    onChangeText={dualima => this.setState({dualima})}
                    keyboardType="numeric"
                  />
                </View>
              </View>
